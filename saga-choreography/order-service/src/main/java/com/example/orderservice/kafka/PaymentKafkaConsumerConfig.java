...
public class PaymentKafkaConsumerConfig {
    ...
    @Bean(name = Constant.PAYMENT_CONTAINER_FACTORY_BEAN_NAME)
    ...
    public ConsumerFactory<String, PaymentEvent> consumerFactory() {
        ...
        configProps.put(ConsumerConfig.GROUP_ID_CONFIG, applicationProps.getKafkaTopics().getPaymentGroupIdConfig());
